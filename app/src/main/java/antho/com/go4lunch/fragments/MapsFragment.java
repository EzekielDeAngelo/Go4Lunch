...
public class MapsFragment extends BaseFragment implements OnMapReadyCallback, GoogleMap.OnPoiClickListener, GoogleMap.OnMyLocationButtonClickListener, GoogleMap.OnMyLocationClickListener {
    ...
    public void onMapReady(GoogleMap map)
    {
        ...
        myLocation.setOnClickListener(v ->
        {
            ...
            LatLng latLng = new LatLng(-33.8523341, 151.2106085);
    ...
    /** PLACES FILTER IMPLEMENTATION TRY **/
    ...
    private void showCurrentPlace()
    {
        ...
        //restrictToRestaurants.add(Integer.toString(Place.TYPE_));
        //PlaceFilter pf;
...
/*            @SuppressWarnings("MissingPermission")
            ...
            filters.add(String.valueOf(Place.TYPE_ESTABLISHMENT));
...
*/
            /*final List<Integer> filters=new ArrayList<>();
            filters.add(Place.TYPE_RESTAURANT);

            ArrayList<String> restrictToRestaurants = new ArrayList<>();
            restrictToRestaurants.add(Integer.toString(Place.TYPE_MUSEUM));
            AutocompleteFilter pf;
            pf = new AutocompleteFilter.Builder()
                    .setTypeFilter(AutocompleteFilter.TYPE)*/

            /*Task<PlaceLikelihoodBufferResponse> placeResult = mPlaceDetectionClient.getCurrentPlace(pf);
